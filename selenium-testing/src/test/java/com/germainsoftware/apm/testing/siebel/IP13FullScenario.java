...
public class IP13FullScenario {
    ...
    public void testUntitledTestCase() throws Exception {
        ...
        driver.findElement(By.xpath("//input[@name='SWEUserName']")).sendKeys(USERNAME);
        driver.findElement(By.xpath("//input[@name='SWEPassword']")).sendKeys(PASSWORD);
